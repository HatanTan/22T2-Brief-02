...
public class StatsSystem : MonoBehaviour
{
    ...
    public void CalculateDancingStats()
    {
        ...
        float StyleConv = (float)style;
        StyleConv = (strength * strengthMultiplier);
        style = (int)StyleConv;
        // luck should be based off our intelligence and be converted at a rate of 1 : 1.5f
        float LuckConv = (float)luck;
        LuckConv = (intelligence * intelligenceMultiplier) / 1.5f;
        luck = (int)LuckConv;
        // rhythm should be based off our agility and be converted at a rate of 1 : 0.5.
        float RhythmConv = (float)rhythm;
        RhythmConv = (agility * agilityMultiplier) / 0.5f;
        rhythm = (int)RhythmConv;
    }
