...
public class FightManager : MonoBehaviour
{
    ...
    private void DecideWinner(Character teamACharacter, Character teamBCharacter)
    {
        ...
        {
            BattleLog.Log("team A Win", teamAColour);
            FightCompleted(teamACharacter, teamBCharacter, false);
            teamBCharacter.myStatsSystem.ChangeHealth(-4);
        }
        else if (playerTwoPowerLevel > playerOnePowerLevel)
        {
            BattleLog.Log("team B Win", teamBColour);
            FightCompleted(teamBCharacter, teamACharacter, false);
            teamACharacter.myStatsSystem.ChangeHealth(-4);
